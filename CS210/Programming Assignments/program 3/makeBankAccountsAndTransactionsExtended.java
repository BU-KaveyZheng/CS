		...
		try
		{
			...
			for( int i = 0; i < inputLines.size(); )
			{
				...
				if( inn.startsWith("new BankAccount") )
				{
					...
					zheng_BankAccount ba = new zheng_BankAccount(lastName, firstName, checkingInitialValue, savingsInitialValue);
				...
				if( inn.startsWith("new EnhancedBankAccount") )
				{
					...
					double checkingInitialValue = Double.parseDouble(st.nextToken());
					double savingsInitialValue = Double.parseDouble(st.nextToken());
					zheng_EnhancedBankAccount eba = new zheng_EnhancedBankAccount(lastName, firstName, checkingInitialValue, savingsInitialValue);
